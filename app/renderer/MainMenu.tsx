        ...
        <div className="MainMenu">
            <ul>
                <li
                    ...
                    className={store.state.screen === "tasks" ? "Selected" : ""}
                >
                    <span>
                        <i className="icofont-tasks"></i> Tasks
                    </span>
                </li>
                <li
                    onClick={() => handleMenuClick("active_apps")}
                    className={store.state.screen === "active_apps" ? "Selected" : ""}
                >
                    <span>
                        <i className="icofont-clock-time"></i> Active Apps
                    </span>
                </li>
                <li
                    onClick={() => handleMenuClick("calendar")}
                    className={store.state.screen === "calendar" ? "Selected" : ""}
                >
                    <span>
                ...
                <li
                    ...
                    className={store.state.screen === "settings" ? "Selected" : ""}
                >
                    <span>
                        <i className="icofont-settings-alt"></i> Settings
                    </span>
                </li>
                <li
                    className={
                        "Hamburger relative " + (store.state.screen === "submenu" ? "Selected" : "")
                    }
                >
                    ...
                    <ul className={`Submenu ${shownSubmenus.submenu ? "Visible" : ""}`}>
                        ...
                        <li>
                            ...
                            >
                                <i className="icofont-exit"></i> <em>Quit</em>{" "}
                                {store.state.taskTimeredId && (
                                    <i className="icofont-warning" title="Task is active!"></i>
                                )}
                            </span>
                        </li>
                    </ul>
